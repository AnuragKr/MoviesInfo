...
public class TopRatedMovies extends AppCompatActivity {
    ...
    private void loadImagePoster() {
        final ProgressDialog pd = new ProgressDialog(TopRatedMovies.this);
        ...
        MySingleton.getInstance(TopRatedMovies.this).addToRequestque(jsonObjectRequest);
    }
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        inflater.inflate(R.menu.new_menu_item, menu);
        return true;
    }
